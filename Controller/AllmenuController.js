...
const getAllMenu = (data, callback) => {
  ...
  db.query(
    `SELECT r.restid, r.brandid, r.rest,r.plan_id,r.plan_name,r.plan_expiry,mt.mtid, mt.menutype, mt.MTImage,c.catid, c.cat, me.menuid, me.menu,me.MImage,me.veg,me.spice,me.price,me.description,
    me.ingredients,me.favourite,me.status1,me.rank1,c.CImage,c.favourite,c.status1,c.rank1,c.notes,r.restcode

    FROM rests r
     JOIN cats c ON r.restid = c.restid
    JOIN menus me ON c.catid = me.catid
     JOIN menutypes mt ON me.mtid = mt.mtid
    WHERE r.cUser = ? and r.restid=?
